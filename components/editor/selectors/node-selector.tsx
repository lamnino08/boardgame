...
import { PopoverContent, PopoverTrigger } from '@/components/ui/popver'
      ...
      <PopoverContent sideOffset={5} align='start' className='w-48 p-1'>
        {items.map(item => (
          <EditorBubbleItem
            ...
            className='bg-card flex cursor-pointer items-center justify-between rounded-sm px-2 py-1 text-sm hover:bg-accent'
          >
